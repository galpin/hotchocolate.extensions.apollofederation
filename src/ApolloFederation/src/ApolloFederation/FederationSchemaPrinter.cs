// https://github.com/ChilliCream/hotchocolate/blob/9d1ead5fdb4643a3fa4c531c5e28037ede0246be/src/HotChocolate/ApolloFederation/src/ApolloFederation/FederationSchemaPrinter.cs
...
namespace HotChocolate.ApolloFederation
{
    public static class FederationSchemaPrinter
    {
            ...
            ReferencedTypes referenced)
        {
            ...
            // // TODO MG.
            // if (objectType.Directives.Any(x => x.Name == "extends"))
            // {
